...
"""
    ...
    def minimum(self):
        return self.psroot.minimum().key
    def insert(self, t):
    ...
    def swap(self,t1,t2,a):
        print self
        # print t1,t2
        t_2 = self.root.find(t2)
        t_1 = self.root.find(t1)
    ...
    def makeList(self, aNode):
        if aNode is None:
            # Stop recursing here
            return []
        return self.makeList(aNode.left) + [aNode.key] + self.makeList(aNode.right)
    def rank(self, t):
